...
| :---: | :--- | :--- | :--- | :---: |
| **Día 1** | **Falso Positivo:** Detección de binario modificado (`diff`) | `Rule ID: 510` (Rootcheck) | Verificación de integridad con `dpkg -V diffutils` y supresión mediante directiva `<ignore>` en `ossec.conf`. | [Ver Análisis](./Análisis-de-falso-positivo-rootcheck-rule-id-510.md) |
